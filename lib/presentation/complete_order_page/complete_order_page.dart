import 'controller/complete_order_controller.dart';
...
class CompleteOrderPage extends StatelessWidget {
  CompleteOrderPage({Key? key})
      : super(
          key: key,
        );

  CompleteOrderController controller =
      Get.put(CompleteOrderController(CompleteOrderModel().obs));
    ...
    return Column(
      ...
      children: [
        ...
        _buildFrame(
          ...
          durationText: "lbl_01_hours_early".tr,
        ),
    ...
    return Column(
      ...
      children: [
        ...
        _buildFrame(
          ...
          durationText: "lbl_01_hours_late".tr,
        ),
        SizedBox(height: 19.v),
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
