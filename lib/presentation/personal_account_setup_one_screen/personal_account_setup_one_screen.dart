...
class PersonalAccountSetupOneScreen
    extends GetWidget<PersonalAccountSetupOneController> {
  PersonalAccountSetupOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  Widget _buildEmail() {
    return CustomTextFormField(
      ...
      hintText: "lbl_e_mail_address".tr,
